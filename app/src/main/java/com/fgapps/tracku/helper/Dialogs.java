...
public class Dialogs {
    ...
    public static void showNumberFormatDialog(final String prefix, final String number, final boolean isLogin){
        if(MainActivity.currentActivity.getWindow().getDecorView().isShown()) {
            ...
            builder.setPositiveButton("Esqueci do 9 extra", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
            ...
            builder.setNegativeButton("Digitei errado", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialogInterface, int i) {
                    return;
                }
    ...
    public static void showWppDialog(final String phone){
        if(MainActivity.currentActivity.getWindow().getDecorView().isShown()) {
            AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity.currentActivity);
    ...
    public static void showMessageDialog(final String phone){
        if(MainActivity.currentActivity.getWindow().getDecorView().isShown()) {
            AlertDialog.Builder builder = new AlertDialog.Builder(MainActivity.currentActivity);
    ...
    public static void showEditDialog(String name, final String phone){
        ...
        message1.setText("Digite um novo nome para o contato:");
        ll.addView(message1);
        ...
        builder.setPositiveButton("Salvar", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                saveNewName(phone, input.getText().toString());
            }
        });
        builder.setNeutralButton("Redefinir", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                if(SyncDatabases.isOnline())
                    saveNewName(phone, "");
    ...
    private static void saveNewName(String phone, String newName){
        ...
        if(newName!=null) MainActivity.getContact(phone).setName(newName);
    }
